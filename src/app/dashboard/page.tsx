  ...
  if (!raffles || raffles.length === 0) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm">
        ...
        <a
          href="/raffles"
          className="mt-6 inline-flex items-center gap-2 rounded-xl bg-primary-600 px-6 py-3 text-sm font-bold text-primary shadow-soft transition-all hover:bg-primary-500"
        >
          Explore raffles
        </a>
      </div>
